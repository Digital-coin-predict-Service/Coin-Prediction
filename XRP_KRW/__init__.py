...
for i in range(1, 13):
    plt.subplot(4, 3, i)
    plt.plot(np.append([np.nan] * 20, prediction[i * 100]))
    plt.plot(np.append(test_x[i * 100][-20:, 0], test_y[i * 100]))
